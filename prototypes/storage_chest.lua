...
storageChest.selection_priority = (storageChest.selection_priority or 50) + 10 -- increase priority to default + 10
storageChest.collision_box = {{-0.15, -0.15}, {0.15, 0.15}}
storageChest.collision_mask = {"rail-layer"} -- collide only with rail entities
